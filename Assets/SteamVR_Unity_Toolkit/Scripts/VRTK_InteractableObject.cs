...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        {
            Vector3 PositionDelta = trackPoint.position - originalControllerAttachPoint.position;
            rb.AddForceAtPosition(PositionDelta, originalControllerAttachPoint.position, ForceMode.VelocityChange);
        }
